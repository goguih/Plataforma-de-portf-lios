...
export default class App extends Component {
    ...
    cadastrar = async() => {
        try{
            const resultado = await api.post("/criador/cadastrar", {
            ...
            if(resultado.data.mensagem == "Criador cadastrado com sucesso")
            this.props.navigation.navigate('LoginCriador');
        else{
            this.setState({
